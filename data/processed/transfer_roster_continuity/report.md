...
The development-selected candidate is **C2_transfer_volume**, chosen using only 2018--2021 rows; its 2022--2025 held-out NLL delta versus production C0 is **0.1126**. The strongest descriptive result among the predeclared transfer candidates is **C9_effective_returning_production**, with held-out ΔNLL **-0.0309**; this comparison was not used to tune the selected candidate. This is a retrospective oracle study, not a production-safe Context change.
...
| C2_transfer_volume | 4.6549 | 0.1126 | 0.1228 | 21.79 | 22.54 | 0.781 | 69.81 |
| C3_minus_rp_transfer_volume | 4.6531 | 0.1108 | 0.1248 | 22.48 | 23.28 | 0.785 | 71.78 |
| C4_rp_x_transfer_volume | 4.5322 | -0.0101 | 0.1109 | 20.03 | 20.43 | 0.827 | 72.36 |
| C5_transfer_talent | 4.7116 | 0.1693 | 0.1274 | 22.55 | 23.86 | 0.757 | 66.78 |
| C6_minus_rp_transfer_talent | 4.7756 | 0.2333 | 0.1332 | 23.56 | 24.84 | 0.742 | 68.13 |
| C7_rp_x_incoming_value | 4.8800 | 0.3376 | 0.1380 | 23.78 | 24.97 | 0.734 | 65.79 |
| C8_rp_x_net_value | 4.5411 | -0.0012 | 0.1118 | 20.15 | 20.59 | 0.825 | 72.01 |
| C9_effective_returning_production | 4.5115 | -0.0309 | 0.1087 | 19.74 | 19.92 | 0.838 | 73.60 |

## Year-by-year primary metrics

| Season | Candidate | NLL | Δ vs C0 | CRPS | Expected-rank MAE | Median-rank MAE | 80% coverage | 80% width |
|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 2022 | C2_transfer_volume | 4.5325 | 0.0657 | 0.1111 | 19.34 | 19.37 | 0.811 | 68.50 |
...
| 2022 | C3_minus_rp_transfer_volume | 4.5407 | 0.0739 | 0.1133 | 19.63 | 19.79 | 0.806 | 70.53 |
...
| 2022 | C5_transfer_talent | 4.5495 | 0.0826 | 0.1124 | 19.49 | 20.43 | 0.804 | 69.73 |
...
| 2022 | C6_minus_rp_transfer_talent | 4.5597 | 0.0928 | 0.1129 | 19.87 | 20.85 | 0.806 | 71.40 |
...
| 2022 | C7_rp_x_incoming_value | 4.5179 | 0.0510 | 0.1130 | 19.57 | 20.06 | 0.813 | 71.21 |
...
| 2022 | C9_effective_returning_production | 4.4688 | 0.0019 | 0.1064 | 18.67 | 18.75 | 0.836 | 73.05 |
| 2023 | C9_effective_returning_production | 4.4895 | 0.0173 | 0.1067 | 19.72 | 20.00 | 0.864 | 73.82 |
| 2024 | C9_effective_returning_production | 4.5411 | -0.0429 | 0.1141 | 20.44 | 20.49 | 0.815 | 72.04 |
| 2025 | C9_effective_returning_production | 4.5448 | -0.0977 | 0.1078 | 20.10 | 20.41 | 0.837 | 75.46 |
...
| 2022 | True | 2273 | 2273 | 0.601 | 0.459 | yes |
